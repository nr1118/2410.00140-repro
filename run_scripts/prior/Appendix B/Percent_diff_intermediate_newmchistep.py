...
# In[ ]:
run_name = 'Percent_diff_intermediate_newmchistep'
...
numpy.save(results_directory + 'Relcent_diff_intermediately_stiff_baryonic_newmchistep.npy',Array)
...
pyplot.savefig(results_directory + 'Percent_diff_intermediate_stiff_plot_newmchistep.png')
pyplot.show()
