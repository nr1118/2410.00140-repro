...
numpy.save(results_directory + 'Relcent_diff_soft_baryonic.npy',Array)
...
pyplot.savefig(results_directory + 'Percent_diff_soft_plot.png')
pyplot.show()
